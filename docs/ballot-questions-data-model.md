...
interface BallotQuestion {
  ...
  title: string | null // Official ballot question title (standalone, if billId is null)
  ...
  voteEffectYes: string | null // Explanation of a YES vote's effects
  voteEffectNo: string | null // Explanation of a NO vote's effects
  fiscalConsequences: string | null // Expected fiscal impact
  inFavor: string | null // Arguments supporting the question
  ...
  endorseCount: number // Number endorsing
  neutralCount: number // Number neutral
  opposeCount: number // Number opposing
}
```
