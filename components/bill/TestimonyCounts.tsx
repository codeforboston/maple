      ...
      <CountDirection className={`me-1 ms-4 my-1`}>
        <Col className={`px-2`}>
          ...
          <Row className={`justify-content-start`}>
            <CountIcon src="/thumbs-endorse.svg" alt={t("counts.endorsements")} height="23" />
        ...
        <Col className={`px-2`}>
          ...
          <Row className={`justify-content-start`}>
            <CountIcon src="/thumbs-neutral.svg" alt={t("counts.neutral")} height="23" />
            <CountTally className={`align-self-center pe-0 ps-2`}>
              {neutral}
            </CountTally>
          </Row>
        ...
        <Col className={`px-2`}>
          ...
          <Row className={`justify-content-start`}>
            <CountIcon src="/thumbs-oppose.svg" alt={t("counts.oppose")} height="23" />
            <CountTally className={`align-self-center pe-0 ps-2`}>
              {oppose}
            </CountTally>
          </Row>
