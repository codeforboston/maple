...
export const LayoutWrapper = function ({ pageTitle, children, title }) {
  return (
    <div className={styles.container}>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerinfo}>
          <div>
            Subscribe to our{" "}
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdXHbMqo299lCBiR_rgxSuxd5-DgEiWNpDAFjawLh66263YLw/viewform">
              {" "}
              newsletter
            </a>
          </div>
...
export default function Layout({
  ...
  return (
    <LayoutWrapper pageTitle={pageTitle} title={title}>
