...
import { Col, Container, Row, Button, Navbar, Nav, NavDropdown } from "../bootstrap"
                ...
                <Navbar variant="dark" expand="lg" className="d-md-none">
                    <Nav>
                        ...
                        <CustomDropdown title="Learn">
                            <NavLink href="/testimonies">Writing Effective Testimonies</NavLink>
                        ...
                        <CustomDropdown title="Our Team">
                            <NavLink href="/testimonies">North Eastern University School of Law</NavLink>
