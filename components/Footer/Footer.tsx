...
import { Col, Container, Row, Navbar, Button } from "../bootstrap"
      ...
      <Row style={{ padding: "2.5em 1.5em 0 1.5em" }}>
        ...
        >
          <Col style={{ alignContent: "flex-start" }}>
            ...
            <NavLink href="/testimonies" other={{ className: `${styles.footerLink}` }}>
              Testimonies
            </NavLink>
            ...
            <NavLink href="/profile" other={{ className: `${styles.footerLink}` }}>
              Profile
            </NavLink>
            
            {authenticated ? <NavLink href="#" other={{ className: `${styles.footerLink}` }}>
              Sign Out
            </NavLink> :
            <NavLink href="login" other={{ className: `${styles.footerLink}` }}>
            Sign In
          </NavLink> 
            }
          </Col>
          <Col>
            ...
            <NavLink href="/learntestimonies" other={{ className: `${styles.footerLink}` }}>
            ...
            <NavLink href="/about" other={{ className: `${styles.footerLink}` }}>
              Our Mission :&amp; Goals
            </NavLink>
            <NavLink href="#" other={{ className: `${styles.footerLink}` }}>
