...
interface NewsfeedCardTitleProps {
  authorUid?: string
  billId?: string
  court?: string
  header?: string
...
export const NewsfeedCardTitle = (props: NewsfeedCardTitleProps) => {
  const {
    authorUid,
    billId,
    court,
...
const CardHeaderImg = (props: NewsfeedCardTitleProps) => {
...
const CardTitleHeadline = (props: NewsfeedCardTitleProps) => {
...
export default NewsfeedCardTitle;