        ...
        <Row className="p-3 g-0">
            <Col md={12}>
                <Dropdown className="our-team-dropdown">
                    <Dropdown.Toggle className="our-team-dropdown-button"><span style={{float: "left"}}>{selectedTab}</span></Dropdown.Toggle>
                    <Dropdown.Menu className="p-2">
                        <Dropdown.Item className="p-2" eventKey="steering_committee" onClick={() => handleTabClick('Steering Committee')}>Steering Committee</Dropdown.Item>
                        <Dropdown.Divider />
                        <Dropdown.Item className="p-2" eventKey="advisory_board" onClick={() => handleTabClick('Advisory Board')}>Advisory Board</Dropdown.Item>
                        <Dropdown.Divider />
                        <Dropdown.Item className="p-2" eventKey="partners" onClick={() => handleTabClick('Partners')}>Partners</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
            </Col>
        </Row>
