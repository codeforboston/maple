...
const EMV_FURTHER_READING = (
  <ul>
    <li>Healthy Elections Project: <a href="https://healthyelections.org/research-vote-mail">Research on Vote-By-Mail</a></li>
    <li>MIT Election Lab: <a href="https://electionlab.mit.edu/research/voting-mail-and-absentee-voting">Voting by mail and absentee voting</a></li>
    <li>Stanford News: <a href="https://news.stanford.edu/2020/09/03/examining-effects-challenges-mail-in-voting/">Examining Effects and Challenges to Mail-in Voting</a></li>
    <li>UChicago News: <a href="https://news.uchicago.edu/story/does-voting-mail-increase-risk-voter-fraud">Why fears about voting by mail are unfounded</a></li>
    <li>Brookings: <a href="https://www.brookings.edu/policy2020/votervital/how-does-vote-by-mail-work-and-does-it-increase-election-fraud/">
        How does vote-by-mail work and does it increase election fraud?</a>
    </li>
    <li>Brennan Center: <a href="https://www.brennancenter.org/our-work/research-reports/why-vote-mail-option-necessary">Why a vote-by-mail option is necessary</a></li>
  </ul>
);
